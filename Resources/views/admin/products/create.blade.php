...
@section('content-header')
    <h1>
        {{ trans('suscriptions::products.title.create product') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.suscriptions.product.index') }}">{{ trans('suscriptions::products.title.products') }}</a></li>
        <li class="active">{{ trans('suscriptions::products.title.create product') }}</li>
    </ol>
@stop
                                ...
                                <div class="tab-content">
                                    ...
                                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                        ...
                                        <div class="tab-pane {{ App::getLocale() == $locale ? 'active' : '' }}"
                                             id="tab_{{ $i }}">
                                            @include('suscriptions::admin.products.partials.create-fields', ['lang' => $locale])
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-right">
                                    <button type="submit"
                                            class="btn btn-primary btn-flat">{{ trans('suscriptions::products.button.create product') }}</button>
                                </div>
                            </div>
